    ...
    function imgSearch(markup){
      ...
      const result = !haveImg ? null :
        <div className={'card-img'} >
          <div className={'Block'}>
            <img src={haveImg[1]} alt='news' className="news-img"/>
          </div>
        </div> 
      return result 
    }
                    ...
                    state.resultDocs.map(elem =>
                        <div className={'card'} key={elem.ok.id}>
                            ...
                            <div className={'card-name'}>
                              <a href={elem.ok.url}  rel="noreferrer" target="_blank">
                                {elem.ok.title.text}
                              </a>
                            </div>
                            ...
                            <div className={'card-footer'}>
                                <div className={'btn'}>
                                    <a href={elem.ok.url !== '' ? elem.ok.url : 404} target="_blank" rel="noreferrer" className="full-text">
                                      Читать в источнике
                                    </a>  
                                </div>
